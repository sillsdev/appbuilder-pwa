...
import { convertIfList, convertIfOrderedList } from './convert-lists';
...
describe('convertUnorderedLists', () => {
    test('preserves normal paragraph', () => {
        ...
        expect(convertIfList(testParagraph)).toEqual(testParagraph);
    });
    ...
    test('flat list', () => {
        ...
        expect(convertIfList(testParagraph)).toEqual(transformed);
    });
    ...
    test('multilevel list', () => {
        ...
        const converted = convertIfList(testParagraph);
...
describe('convert ordered list', () => {
    test('flat list', () => {
        ...
        expect(convertIfOrderedList(testParagraph)).toEqual(transformed);
    });
