<script lang="ts">
    // Forward 10 from https://github.com/google/material-design-icons/blob/1cdf3a193b7df33246abf562250e9b9f918e5ca7/src/av/forward_10/materialiconsoutlined/24px.svg
    // Filled = 1
    // Weight = 400
    // Grade = 0
    // Optical size = 24px
...
>
    <g
        ><rect fill="none" height="24" width="24" /><rect fill="none" height="24" width="24" /><rect
            fill="none"
            height="24"
            width="24"
        /></g
