...
export class ConvertMedia extends Task {
    ...
    async convertMedia(
        ...
        if (compareVersions(configData.data.programVersion!, '13.4') < 0) {
            // Prior to 13.4, we had situations where the iOS icon was defined, but the files were not present. The app-touch-icon.png is
